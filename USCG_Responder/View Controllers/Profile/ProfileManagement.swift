...
class ProfileManagement:UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate{
    ...
    override func viewDidLoad() {
        ...
        ref.observe(.value, with:{ (snapshot: DataSnapshot) in
            ...
            //Populate textviews
            self.firstName.text = maybe!["First_Name"] as? String
            self.lastName.text = maybe!["Last_Name"] as? String
            self.dob.text = maybe!["DOB"] as? String
            self.address.text = maybe!["Address"] as? String
            self.email.text = maybe!["Email"] as? String
            self.emergencyContact.text = maybe!["Emergency_Contact_Name"] as? String
            self.emergencyNumber.text = maybe!["Emergency_Contact_Phone"] as? String
            self.vesselNo.text = maybe!["Vessel_No"] as? String
            self.medicalNotes.text = maybe!["Medical_Notes"] as? String
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        let temp = info[.originalImage] as? UIImage
