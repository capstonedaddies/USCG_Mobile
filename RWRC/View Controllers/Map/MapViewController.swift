...
class MapViewController: UIViewController, CLLocationManagerDelegate, GMSMapViewDelegate {
    ...
    @IBAction func engageTester(_ sender: Any) {
      ...
      cvc.createChannel(channelName: AppSettings.uid)
      self.present(ChatViewController(user: Auth.auth().currentUser!, channel: Channel(name: AppSettings.uid)), animated: true, completion: nil)
